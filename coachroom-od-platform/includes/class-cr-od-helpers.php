		...
		return array(
			...
			'tools' => array(
				...
				'grow' => array(
					...
					'steps'   => array(
						'Goal: هدف مشخص و قابل مشاهده جلسه را بپرسید.',
						'Reality: وضعیت فعلی، موانع و داده‌های واقعی را بشنوید.',
						'Options: گزینه‌های راه‌حل را با پرسش‌های باز تولید کنید.',
						'Will: یک قدم کوچک، زمان و معیار بررسی انتخاب کنید.',
					),
					'kpi'     => 'تعداد جلسات مربی‌گری مؤثر و پیشرفت اهداف توسعه فردی/تیمی.',
				),
				'okr' => array(
				...
				'one2one' => array(
					...
					'steps'   => array(
						...
						'یک بازخورد SBI و یک پرسش GROW در هر جلسه به‌کار ببرید.',

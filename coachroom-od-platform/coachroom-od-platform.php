 ...
 * Description:       سامانه توسعه سازمانی CoachRoom؛ تشخیص ۶۳ سؤالی سازمان بر اساس موج‌های سازمانی + مدل شش‌جعبه‌ای وایزبورد + مدل نگرش شغلی کارکنان در کنار مدل تعالی EFQM، هم‌راستا با برنامه راهبردی منابع انسانی صنعت نفت در افق ۱۴۱۰. شامل سنجش روایی و پایایی، انتخاب تطبیقی راهبرد، OKR، نقشه راه و گزارش مدیران.
 * Version:           1.11.0
...
final class Coachroom_OD_Platform {
	...
	private function __construct() {
		...
		add_action( 'init', array( 'Coachroom_OD_DB', 'maybe_upgrade' ), 1 );
		...
		<div class="wrap">
			...
			<div class="card" style="max-width:760px;padding:18px 22px;">
				...
				<ul style="list-style:disc;padding-inline-start:20px;">
					...
					<li>ارزیابی ۶۳ سؤالی: ۳۳ سؤال بلوغ ساختاری/فرهنگی (شامل رسمیت و چابکی مجزا) + ۱۸ سؤال تشخیصی شش‌جعبه‌ای وایزبورد + ۱۲ سؤال مدل نگرش شغلی</li>
					<li>تشخیص موج سازمانی، مدل تعالی EFQM، شش جعبه وایزبورد، مدل نگرش شغلی و افق ۱۴۱۰ به‌صورت جداگانه؛ انتخاب تطبیقی راهبرد + قطب‌نمای 7S مک‌کنزی (هفت مؤلفه) با رادار، KPI، نشانه‌ها و راهنما در داشبورد/گزارش</li>
					<li>تب «خانه» رایگان با نقشه راه کامل و درگاه ثبت‌نام سه‌آیتمی (نام، ایمیل، شرکت/واحد) برای تب‌های مدیریتی</li>
					<li>تب «راهنمای اجرا» با توضیح عملی SBI، OSKAR، OKR، AAR، RACI، جلسه ۱:۱ و کالیبراسیون + KPI</li>
					<li>پاپ‌آپ واژه‌ها و اختصارها در سراسر پلتفرم (EFQM، OKR، افق ۱۴۱۰، امنیت روانی و…)</li>
					<li>سنجش روایی محتوا و پایایی (آلفای کرونباخ) در پنل مدیران</li>
					<li>نقشه راه ۳۰/۶۰/۹۰ روزه مبتنی بر بلوغ واقعی و OKR افق ۱۴۱۰؛ مربی‌گری سرپرستان فقط در صورت آمادگی</li>
			...
			<div class="card" style="max-width:760px;padding:18px 22px;">
				...
				<table class="widefat striped" style="margin-top:10px;">
					<tbody>
						...
						<tr><th>مدل نگرش شغلی</th><td><?php echo esc_html( $health['dashboard']['attitude']['level'] ?? '—' ); ?> — امتیاز <?php echo esc_html( $health['dashboard']['attitude']['overall'] ?? '—' ); ?> از ۴</td></tr>
						<tr><th>هم‌راستایی افق ۱۴۱۰</th><td><?php echo esc_html( $health['dashboard']['hr1410']['level'] ?? '—' ); ?> — امتیاز <?php echo esc_html( $health['dashboard']['hr1410']['overall'] ?? '—' ); ?>، فاصله تا هدف <?php echo esc_html( $health['dashboard']['hr1410']['gap'] ?? '—' ); ?></td></tr>

...
(function () {
  ...
  var TAB_PANELS = ['dashboard', 'assessment', 'roadmap', 'departments', 'blog', 'guide', 'reports'];
  ...
  var GLOSSARY = [
    ...
    ['GROW', 'مدل مربی‌گری GROW شامل هدف (Goal)، وضعیت فعلی (Reality)، گزینه‌ها (Options) و اراده/قدم بعدی (Will) است؛ از پرکاربردترین مدل‌های مربی‌گری عملکردی.'],
  ...
  function selfTest() {
    var issues = [];
    var requiredIds = [
      'cr-dashboard', 'cr-assessment', 'cr-roadmap', 'cr-departments', 'cr-blog', 'cr-guide', 'cr-reports',
